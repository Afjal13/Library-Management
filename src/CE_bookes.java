 ...
 */
public class CE_bookes extends javax.swing.JFrame {
    ...
    public CE_bookes(String s) {
        super("CE Book Selection");
        initComponents();
        conn = db.java_db();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(242, 121, 53), 2), "CE Bookes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(242, 121, 53))); // NOI18N
        ...
        jButton8.setText("CE Bookes List");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            String sql="select *from BookRegForm where book_dept = 'CE'" ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CE_bookes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CE_bookes(n).setVisible(true);
            }
        });
    }
