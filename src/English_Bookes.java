 ...
 */
public class English_Bookes extends javax.swing.JFrame {
    ...
    public English_Bookes(String s) {
        super("English Book Selection");
        initComponents();
        conn = db.java_db();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(242, 121, 53), 2), "ENGLISH Bookes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(242, 121, 53))); // NOI18N
        ...
        jButton1.setText("English Bookes List");
        ...
        jLabel6.setText("Book Serial Number");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(bookname, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                        .addComponent(authorname, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                        .addComponent(jDateChooser1, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
                    .addComponent(booksid, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        setSize(new java.awt.Dimension(1287, 681));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try{
            ...
            pst.setString(6, authorname.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="select *from BookRegForm where book_dept = 'English'" ;
    ...
    private void booknameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_booknameKeyReleased
        ...
        try {
            ...
            String sql = "select from BookRegForm where book_name=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1,booksid.getText());
            rs=pst.executeQuery();
            ...
            Logger.getLogger(English_Bookes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(English_Bookes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new English_Bookes(n).setVisible(true);
            }
        });
    }
